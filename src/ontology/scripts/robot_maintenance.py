...
QUERIES = { # Sparql 1.1 (which Protege snap sparql doesn't quite support )
	...
	# Kill all oboInOwl:hasSynonym, oboInOwl:hasExactSynonym, alt label
	# obo:IAO_0000118 which textually match label
	'duplicate_synonym': {
		'active': True,
		'type': 'DELETE',
...
# PAST QUERIES - USUALLY JUST 1-off but may have useful content:
DEPRECATION_REVERSAL = {
